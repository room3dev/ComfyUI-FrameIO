---
description: how to add or update nodes in ComfyUI-FrameIO
---
...
- **Standard Outputs**: Every node should return an `INT` as the second output representing the `count` of items processed.
...
2. **Implement Node Class**:
   - Ensure `CATEGORY = "FrameIO"`.
   - Implement `DESCRIPTION`.
   - Implement `RETURN_TYPES = ("IMAGE", "INT")` (or similar).
...
- [ ] Ensure `INT` output for item count.
